...
<h3> Welcome   <s:property value="role"/></h3>
</s:iterator>

					     <div align="left">
					     <s:url var="viewPending" action="viewPendingDiscounts" namespace="/" ></s:url>
                         <s:a href="%{#viewPending}"><strong>View Unapproved Discounts</strong></s:a>
                         </div>
                         <br>
                      	<br>
						<div align="left">
                         <s:url var="viewAll" action="viewAllDiscounts" namespace="/"></s:url>
                          <s:a href="%{#viewAll}"><strong> View All Discounts</strong></s:a>
                            </div>
