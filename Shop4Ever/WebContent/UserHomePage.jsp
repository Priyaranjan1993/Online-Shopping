...
<body>
    ...
    <div class="pre-loader">
        <div class="load-con">
            <img src="img/freeze/imgge4.png" class="animated fadeInDown" alt="">
            <div class="spinner">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                           ...
                           <!--  <li><a href="#features">features</a>
                            ...
                            <!-- <li><a href="#screens">Orders</a> -->
                            </li>
                            <!-- <li><a href="#demo">demo</a>
                            </li> -->
                           <!--  <li><a class="getApp" href="#getApp">get app</a>
                            </li> -->
                            <li><a class="getApp" href="#order">Orders</a>
                            </li>
                        </ul>
                    </div>
                    <!-- /.navbar-collapse -->
                ...
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                        ...
                        <div class="tp-caption lfl fadeout hidden-xs"
                            ...
                            <img src="img/freeze/Slides/nexus4.png" alt="">
                        </div>
                        ...
                        <div class="tp-caption sfb hidden-xs" data-x="550" data-y="center" data-hoffset="0" data-voffset="85" data-speed="1000" data-start="1700" data-easing="Power4.easeOut">
                            <a href="#about" class="btn btn-primary inverse btn-lg">See Details</a>
                        </div>
                        <div class="tp-caption sfr hidden-xs" data-x="730" data-y="center" data-hoffset="0" data-voffset="85" data-speed="1500" data-start="1900" data-easing="Power4.easeOut">
                            <a href="#getApp" class="btn btn-default btn-lg">BUY</a>
                        </div>
                    ...
                    <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                        ...
                        <div class="tp-caption lfb fadeout hidden-xs"
                            ...
                            data-start="700"
                            data-easing="Power4.easeOut">
                            <img src="img/freeze/Slides/apple3.png" alt="">
                        </div>
                        ...
                        <div class="tp-caption large_white_light sft" data-x="center" data-y="250" data-hoffset="0" data-voffset="0" data-speed="1000" data-start="1400" data-easing="Power4.easeOut">
                            LIVE THE BEATS <i class="fa fa-heart"></i>
                        </div>
                                ...
                                %>
                                 ...
                                 Welcome, <s:property value="#session.userid"/>  
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" name ="employeeId" placeholder="Your name">
                                    </div>
                                    <div class="form-group">
                                        <input type="password" class="form-control" name="password" placeholder="Your password">
                                    </div>
                                    <div class="form-group">
                                        Employee<input type="radio"  name="UserType" value="employee">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        Customer<input type="radio"  name="UserType" value="customer">
