...
<table class="table">
   ...
   <tbody>
      <tr class="success">
         <td>112</td>
         <td>44</td>
         <td>22-r , SN Road , 4Th colony , Delhi</td>
         <td>22-r , SN Road , 4Th colony , Delhi</td>
         <td>4400</td>
         <td>20%</td>
         <td>13.5%</td>
         ...
         <td><div class="form-group">
                                            <select class="form-control">
													  <option value="New_Delhi">Payment Done</option>
													  <option value="Mumbai">COD Payment Pending</option>
													  <option value="Chennai">Shipping in progress</option>
